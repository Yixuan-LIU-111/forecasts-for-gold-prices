"""Main entry point for DFII10 (TIPS 10-Year) scraper.
...
from scraper import scrape_dfii10
from storage import save_data, load_latest
from utils import setup_logging


def print_data(data: dict):
    """Pretty-print the scraped DFII10 data."""
    print("\n=== TIPS 10-Year Yield (DFII10) ===\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="DFII10 (TIPS 10-Year Yield) Scraper from FRED"
    )
    ...
    if args.show_last:
        ...
        if data:
            ...
            print("No saved DFII10 data found.")
            sys.exit(1)
        return
    ...
    data = scrape_dfii10()
    if data is None:
        print("Failed to scrape DFII10 data.")
        sys.exit(1)
